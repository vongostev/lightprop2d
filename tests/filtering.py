...
def test_filter_composer():
    ...
    try:
        ...
        print(E)
    print(FilterComposer(plane_wave, ()).f)
    print(FilterComposer(plane_wave, ()).f)
    print(FilterComposer(square_hole, (1, )).f)
    #print(FilterComposer([plane_wave] * 2, ()).f)
    print(FilterComposer([square_hole] * 2, (1, )).f)
    print(FilterComposer([square_hole, rectangle_hole], ((1, ), (1, 0.5))).f)
...
fs = [
      ...
      FilterComposer([square_hole, rectangle_hole], ((d, ), (d * 2, d * 0.5))).f,
      ]
